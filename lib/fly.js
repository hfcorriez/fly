...
class Fly {
  ...
  async call (name, event, initalContext) {
    ...
    targetEvent && targetEvent.props && chian.push((event) => Validator.validateProps(event, targetEvent.props))
    ...
    fn.props && chian.push((event) => Validator.validateProps(event, fn.props))
