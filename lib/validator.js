...
module.exports = {
  ...
  validators: {
    ...
    fn: (input, config) => config.fn(input)
  },
  ...
  validateOne (input, definition, name, $all) {
    ...
    if (typeof definition === 'string') {
      ...
      definition = { type: 'fn', fn: definition }
    ...
    // Post format
    if (definition.post) {
      value = this.format(definition.post, value)
    }
