...
exports.flyCall = async function flyCall ({ modulePath, mockPath, event, context = {} }, forkOptions) {
  event = event || {}
  debug(DEFAULT_FORK_OPTIONS)
  forkOptions = Object.assign({}, DEFAULT_FORK_OPTIONS, forkOptions || {})
  const mock = fork(path.join(__dirname, 'call-fly.js'), [modulePath, mockPath, JSON.stringify(event), JSON.stringify(context)], forkOptions)
